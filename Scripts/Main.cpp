...
void suken::Awake(){
	...
	edit_me.SetButton(200, 85, 250, 115, YELLOW, "Å®", BLACK, upATK);
	edit_me.SetButton(40, 85, 90, 115, YELLOW, "Å©", BLACK, downATK);
	edit_me.SetButton(200, 125, 250, 155, YELLOW, "Å®", BLACK, upSPD);
	edit_me.SetButton(40, 125, 90, 155, YELLOW, "Å©", BLACK, downSPD);
	edit_me.SetButton(200, 165, 250, 195, YELLOW, "Å®", BLACK, upHP);
	edit_me.SetButton(40, 165, 90, 195, YELLOW, "Å©", BLACK, downHP);
